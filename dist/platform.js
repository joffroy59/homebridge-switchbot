...
export class SwitchBotPlatform {
    ...
    async setupwebhook() {
        ...
        if (this.config.options?.webhookURL) {
            ...
            try {
                const { body, statusCode } = await request('https://api.switch-bot.com/v1.1/webhook/setupWebhook', {
                    method: 'POST',
            ...
            try {
                const { body, statusCode } = await request('https://api.switch-bot.com/v1.1/webhook/updateWebhook', {
                    method: 'POST',
                    headers: this.generateHeaders(),
                    body: JSON.stringify({
            ...
            try {
                const { body, statusCode } = await request('https://api.switch-bot.com/v1.1/webhook/queryWebhook', {
                    method: 'POST',
                    headers: this.generateHeaders(),
                    body: JSON.stringify({
                        'action': 'queryUrl',
            ...
            this.api.on('shutdown', async () => {
                try {
                    const { body, statusCode } = await request('https://api.switch-bot.com/v1.1/webhook/deleteWebhook', {
                        method: 'POST',
                        headers: this.generateHeaders(),
                        body: JSON.stringify({
