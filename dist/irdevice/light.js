...
export class Light {
    ...
    // Services
    lightBulbService;
    ProgrammableSwitchServiceOn;
    ProgrammableSwitchServiceOff;
    // Characteristic Values
    On;
    ProgrammableSwitchEventOn;
    ProgrammableSwitchOutputStateOn;
    ProgrammableSwitchEventOff;
    ProgrammableSwitchOutputStateOff;
    FirmwareRevision;
    // Config
    deviceLogging;
    disablePushOn;
    ...
    async updateHomeKitCharacteristics() {
        if (this.device.irlight?.stateless) {
            ...
            if (this.ProgrammableSwitchOutputStateOn === undefined) {
                ...
                this.ProgrammableSwitchServiceOn?.updateCharacteristic(this.hap.Characteristic.ProgrammableSwitchOutputState, this.ProgrammableSwitchOutputStateOn);
            ...
            if (this.ProgrammableSwitchOutputStateOff === undefined) {
                ...
                this.ProgrammableSwitchServiceOff?.updateCharacteristic(this.hap.Characteristic.ProgrammableSwitchOutputState, this.ProgrammableSwitchOutputStateOff);
                this.debugLog(`${this.device.remoteType}: ${this.accessory.displayName} updateCharacteristic`
                    + ` ProgrammableSwitchOutputStateOff: ${this.ProgrammableSwitchOutputStateOff}`);
            }
        }
