...
import { hs2rgb, rgb2hs, m2hs, Devices } from '../settings.js';
/**
 * Platform Accessory
...
export class CeilingLight {
    ...
    cacheKelvin;
    // Updates
    ceilingLightUpdateInProgress;
    doCeilingLightUpdate;
    // Connection
    OpenAPI;
    BLE;
    ...
    async openAPIparseStatus() {
        ...
        if (this.OpenAPI_RGB) {
            ...
            this.debugLog(`${this.device.deviceType}: ${this.accessory.displayName}` + ` hs: ${JSON.stringify(rgb2hs(Number(red), Number(green), Number(blue)))}`);
            // Hue
            this.Hue = hue;
