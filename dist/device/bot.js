...
export class Bot {
    ...
    // OpenAPI Status
    OpenAPI_On;
    OpenAPI_BatteryLevel;
    OpenAPI_FirmwareRevision;
    // BLE Status
    BLE_On;
    BLE_Mode;
    BLE_BatteryLevel;
    ...
    async updateHomeKitCharacteristics() {
        ...
        if (this.botDeviceType === 'garagedoor') {
            if (this.On === undefined) {
                ...
                if (this.On) {
                    this.garageDoorService?.updateCharacteristic(this.hap.Characteristic.TargetDoorState, this.hap.Characteristic.TargetDoorState.OPEN);
                    this.garageDoorService?.updateCharacteristic(this.hap.Characteristic.CurrentDoorState, this.hap.Characteristic.CurrentDoorState.OPEN);
                    ...
                    this.garageDoorService?.updateCharacteristic(this.hap.Characteristic.TargetDoorState, this.hap.Characteristic.TargetDoorState.CLOSED);
                    this.garageDoorService?.updateCharacteristic(this.hap.Characteristic.CurrentDoorState, this.hap.Characteristic.CurrentDoorState.CLOSED);
                    this.debugLog(`${this.device.deviceType}: ` + `${this.accessory.displayName} updateCharacteristic TargetDoorState: Open, CurrentDoorState: Open`);
                }
            }
            ...
            if (this.On === undefined) {
                ...
                if (this.On) {
                    ...
                    this.windowCoveringService?.updateCharacteristic(this.hap.Characteristic.PositionState, this.hap.Characteristic.PositionState.STOPPED);
                    this.debugLog(`${this.device.deviceType}: ${this.accessory.displayName} updateCharacteristic TargetPosition: 100, CurrentPosition: 100`);
                }
                else {
            ...
            if (this.On === undefined) {
                ...
                if (this.On) {
                    this.lockService?.updateCharacteristic(this.hap.Characteristic.LockTargetState, this.hap.Characteristic.LockTargetState.UNSECURED);
                    this.lockService?.updateCharacteristic(this.hap.Characteristic.LockCurrentState, this.hap.Characteristic.LockCurrentState.UNSECURED);
                    ...
                    this.lockService?.updateCharacteristic(this.hap.Characteristic.LockCurrentState, this.hap.Characteristic.LockCurrentState.SECURED);
            ...
            if (this.On === undefined) {
                ...
                if (this.On) {
                    this.statefulProgrammableSwitchService?.updateCharacteristic(this.hap.Characteristic.ProgrammableSwitchEvent, this.hap.Characteristic.ProgrammableSwitchEvent.SINGLE_PRESS);
