...
export class Humidifier {
    ...
    OpenAPI_CurrentTemperature;
    OpenAPI_CurrentRelativeHumidity;
    OpenAPI_CurrentHumidifierDehumidifierState;
    OpenAPI_RelativeHumidityHumidifierThreshold;
    // BLE Others
    connected;
    onState;
    autoMode;
    ...
    constructor(platform, accessory, device) {
        ...
        this.humidifierService.setCharacteristic(this.hap.Characteristic.CurrentHumidifierDehumidifierState, this.CurrentHumidifierDehumidifierState);
    ...
    async openAPIpushChanges() {
        ...
        if (this.TargetHumidifierDehumidifierState === this.hap.Characteristic.TargetHumidifierDehumidifierState.HUMIDIFIER &&
            this.Active === this.hap.Characteristic.Active.ACTIVE) {
        ...
        else if (this.TargetHumidifierDehumidifierState === this.hap.Characteristic.TargetHumidifierDehumidifierState.HUMIDIFIER_OR_DEHUMIDIFIER &&
            this.Active === this.hap.Characteristic.Active.ACTIVE) {
    ...
    async pushAutoChanges() {
        ...
        if (this.TargetHumidifierDehumidifierState === this.hap.Characteristic.TargetHumidifierDehumidifierState.HUMIDIFIER_OR_DEHUMIDIFIER &&
            this.Active === this.hap.Characteristic.Active.ACTIVE) {
    ...
    async updateHomeKitCharacteristics() {
        ...
        if (this.CurrentHumidifierDehumidifierState === undefined) {
            ...
            this.humidifierService.updateCharacteristic(this.hap.Characteristic.CurrentHumidifierDehumidifierState, this.CurrentHumidifierDehumidifierState);
            this.debugLog(`${this.device.deviceType}: ${this.accessory.displayName}` +
        ...
        if (this.TargetHumidifierDehumidifierState === undefined) {
            ...
            this.humidifierService.updateCharacteristic(this.hap.Characteristic.TargetHumidifierDehumidifierState, this.TargetHumidifierDehumidifierState);
            this.debugLog(`${this.device.deviceType}: ${this.accessory.displayName}` +
        ...
        if (this.RelativeHumidityHumidifierThreshold === undefined) {
            ...
            this.humidifierService.updateCharacteristic(this.hap.Characteristic.RelativeHumidityHumidifierThreshold, this.RelativeHumidityHumidifierThreshold);
            this.debugLog(`${this.device.deviceType}: ${this.accessory.displayName}` +
