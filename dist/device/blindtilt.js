...
export class BlindTilt {
    ...
    OpenAPI_Direction;
    OpenAPI_Calibration;
    OpenAPI_CurrentPosition;
    OpenAPI_FirmwareRevision;
    OpenAPI_CurrentAmbientLightLevel;
    // OpenAPI Others
    Mode;
    setPositionMode;
    ...
    async updateHomeKitCharacteristics() {
        ...
        if (this.mappingMode === BlindTiltMappingMode.UseTiltForDirection) {
            if (this.CurrentHorizontalTiltAngle === undefined || Number.isNaN(this.CurrentHorizontalTiltAngle)) {
                ...
                this.windowCoveringService.updateCharacteristic(this.hap.Characteristic.CurrentHorizontalTiltAngle, Number(this.CurrentHorizontalTiltAngle));
                this.debugLog(`${this.device.deviceType}: ${this.accessory.displayName} 
