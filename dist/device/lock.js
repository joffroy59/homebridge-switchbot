...
export class Lock {
    ...
    OpenAPI_LockCurrentState;
    OpenAPI_ContactSensorState;
    // BLE Status
    BLE_BatteryLevel;
    BLE_LockCurrentState;
    BLE_Calibration;
    BLE_ContactSensorState;
    // BLE Others
    BLE_IsConnected;
    // Config
    scanDuration;
     ...
     */
    async handleLatchCharacteristic(value, callback) {
